...
void main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt2cmxseXBpZWZ0ZGNvenRzeG5vIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ1NTQ5NDksImV4cCI6MjA2MDEzMDk0OX0.F9rHyAZ4TXRQgQdXxM2BtgRNt03nLvlAcAdkJoxSesg',
  );
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          scaffoldBackgroundColor:
              const Color(0xFFF5F5F5), // Fundo claro e suave
          ...
          textTheme: const TextTheme(
            ...
            bodyLarge: TextStyle(
                fontSize: 18,
                color: Colors.black87), // Texto maior para legibilidade
